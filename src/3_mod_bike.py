...
def modify_network():
    ...
    length_multipliers = {
        "shared_lane": config['bike_length_multipliers']['shared_lane'],
        "shoulder_bikeway":  config['bike_length_multipliers']['shoulder_bikeway'],
        "bike_lane":  config['bike_length_multipliers']['bike_lane'],
        "buffered_bike_lane": config['bike_length_multipliers']['buffered_bike_lane'],
        "protected_bike_lane":  config['bike_length_multipliers']['protected_bike_lane'],
        "bike_blvd":  config['bike_length_multipliers']['bike_blvd'],
        "shared_use_path": config['bike_length_multipliers']['shared_use_path']
    }
